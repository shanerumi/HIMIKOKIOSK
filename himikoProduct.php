...
<head>
    ...
    <link rel="stylesheet" href="himikoproduct.css">
    <title>Himiko Product</title>
</head>
<body>
            ...
            while($himikoprod = mysqli_fetch_assoc($ressql)){
                echo '
                    <div class="himikocard">
                        ...
                        <button class="himikoviewbtn" onclick="window.location.href=\'himikoRegister.php\'">View</button>
                    </div>
                ';
            }
        }
